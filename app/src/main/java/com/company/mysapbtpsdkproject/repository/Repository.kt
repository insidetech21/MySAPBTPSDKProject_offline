...
import com.company.mysapbtpsdkproject.archcomp.SingleLiveEvent
import com.company.mysapbtpsdkproject.repository.OperationResult.Operation
...
class Repository<T : EntityValue>(
    ...
    fun downloadMedia(entity:T, successHandler:Action1<ByteArray>,
        failureHandler:Action1<RuntimeException>) {
            zCIMS_INT_SRV_Entities.downloadMediaAsync(entity,
