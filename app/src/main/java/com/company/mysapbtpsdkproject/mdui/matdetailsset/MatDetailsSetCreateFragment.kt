...
import com.company.mysapbtpsdkproject.databinding.FragmentMatdetailssetCreateBinding
...
class MatDetailsSetCreateFragment : InterfacedFragment<MatDetails, FragmentMatdetailssetCreateBinding>() {
    ...
    private fun createMatDetails(): MatDetails {
        ...
        entity.unsetDataValue(MatDetails.mblnr)
        entity.unsetDataValue(MatDetails.matnr)
        return entity
    }
    ...
    private fun onComplete(result: OperationResult<MatDetails>) {
        ...
        if (result.error != null) {
            ...
            if (currentActivity.resources.getBoolean(R.bool.two_pane)) {
                ...
                (listFragment as MatDetailsSetListFragment).refreshListData()
            }
