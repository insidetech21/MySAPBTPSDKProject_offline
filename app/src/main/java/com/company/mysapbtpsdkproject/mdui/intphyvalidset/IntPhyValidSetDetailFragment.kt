...
import com.company.mysapbtpsdkproject.databinding.FragmentIntphyvalidsetDetailBinding
...
class IntPhyValidSetDetailFragment : InterfacedFragment<IntPhyValid, FragmentIntphyvalidsetDetailBinding>() {
    ...
    private fun setDetailImage(objectHeader: ObjectHeader, intPhyValidEntity: IntPhyValid) {
        if (intPhyValidEntity.getOptionalValue(IntPhyValid.werks) != null && intPhyValidEntity.getOptionalValue(IntPhyValid.werks).toString().isNotEmpty()) {
