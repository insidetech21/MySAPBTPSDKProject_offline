...
import com.company.mysapbtpsdkproject.databinding.FragmentInpostlocsetCreateBinding
...
class INPOStLocSetCreateFragment : InterfacedFragment<INPOStLoc, FragmentInpostlocsetCreateBinding>() {
    ...
    private fun createINPOStLoc(): INPOStLoc {
        ...
        entity.unsetDataValue(INPOStLoc.werks)
        return entity
    }
    ...
    private fun onComplete(result: OperationResult<INPOStLoc>) {
        ...
        if (result.error != null) {
            ...
            if (currentActivity.resources.getBoolean(R.bool.two_pane)) {
                ...
                (listFragment as INPOStLocSetListFragment).refreshListData()
            }
