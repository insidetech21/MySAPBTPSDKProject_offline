...
import com.company.mysapbtpsdkproject.databinding.FragmentLoginsrvsetDetailBinding
...
class LoginSrvSetDetailFragment : InterfacedFragment<LoginSrv, FragmentLoginsrvsetDetailBinding>() {
    ...
    private fun setDetailImage(objectHeader: ObjectHeader, loginSrvEntity: LoginSrv) {
        if (loginSrvEntity.getOptionalValue(LoginSrv.compCode) != null && loginSrvEntity.getOptionalValue(LoginSrv.compCode).toString().isNotEmpty()) {
